...
各フェーズで受講者が Codex に与える指示の雛形。

「セットアップ確認」「投稿一覧」「投稿作成」までは雛形をそのまま配布、
「投稿詳細」以降は **受講者が自分で書く**ようにすると学習効果が高い。
...
## 仕上げ＋PR整流化＋プロンプトカタログ作成 (17-19時間目)
...
観点:
  ...
  5. PR を作成し、.github/pull_request_template.md の 5 セクションを全部埋める
...
(プロンプトは不要。受講者が PR を画面共有して、口頭で議論)
