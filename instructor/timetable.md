...
| 時間目 | 物理日 | フェーズ名 | 受講者の動き | 講師の動き | 想定リスク |
|---|---|---|---|---|---|
...
| 17h-19h | 3日目 | 仕上げ＋PR整流化＋プロンプトカタログ作成 | PR 説明文整備、`docs/prompts-i-used.md` 作成、ルーブリック自己採点準備 | PR テンプレ 5 セクションと prompts-i-used.md の3件以上を確認 | PR タイトルが「色々修正」、prompts-i-used.md が空 |
| 19h-20h | 3日目 | 相互レビュー | PR 画面共有、隣の人が 3 観点 (機能・テスト・コミット) でコメント | 1 人 1 つだけ「ここ良い」を全体共有 | レビューコメントが「いいね」だけ |
...
1. **0-1h で 30 分以上詰まったら強制的に H2 プロファイルに逃がす**。受講者の DB トラブルで全員を止めない。
2. **2日目朝・3日目朝の 0.25h はウォームアップ専用**。前日 PR のスモークテストで再現性 NG を早期発見する。
3. **2日目終業 (13時間目) で MUST 未完走の受講者はフォロー対象**。3日目朝に H2 強制移行を含む救済策を提示する。
...
| 物理日 | 時間目 | 講師が確認すること |
|---|---|---|
| 1日目終業 | 4h | M1 が PR 化されているか、main へマージ済みか |
| 2日目終業 | 13h | MUST 5項目 + SHOULD 2項目 (S1/S2) が main に入っているか、カバレッジ 80% 到達済みか |
