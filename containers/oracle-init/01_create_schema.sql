...
-- APP_USER (tsubuyaki) の PDB (XEPDB1) に対して自動実行される。
--
...
PROMPT === tsubuyaki schema init: granting extra privileges ===

-- Flyway のスキーマヒストリ表作成と、講師のデモ用シーケンス作成に必要
GRANT CREATE SEQUENCE TO tsubuyaki;
GRANT CREATE PROCEDURE TO tsubuyaki;
GRANT CREATE VIEW TO tsubuyaki;
GRANT CREATE SYNONYM TO tsubuyaki;
...
PROMPT === tsubuyaki schema init: done ===
